          ...
          <div className="page-content">
              ...
              {user.accountStatus === 'pending' && (
                <Alert className="border-amber-500/50 bg-amber-500/10">
                  ...
                  <AlertDescription className="text-amber-800 dark:text-amber-200">
                    ...
                    You&apos;ll be able to access the full platform once your
                    profile is approved. We&apos;ll notify you via email when
            ...
            <Section>
              <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="col-span-2">
                  <PortfolioProjectsSection userId={user.id} isOwner={true} />
                </div>

                {/* Skills Section - Earned from projects */}
                <div className="col-span-2">
                  <ProfileSkillsSection userId={user.id} isOwner={true} />
                </div>
              </div>
            </Section>
          </div>
