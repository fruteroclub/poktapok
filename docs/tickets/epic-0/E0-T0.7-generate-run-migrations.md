...
✅ Migration 0000_initial_schema.sql created
```
...
```
🚀 Running migrations...
✅ Migration 0000_initial_schema.sql applied
...
async function verifyMigration() {
  ...
  try {
    ...
    Object.entries(constraintsByTable).forEach(([table, conList]) => {
      console.log(`  ${table}:`)
      conList.forEach((con) => console.log(`    ✅ ${con.type}: ${con.name}`))
    })
...
- ✅ 7 enums defined
- ✅ 24+ indexes created
- ✅ All foreign keys with proper CASCADE policies
