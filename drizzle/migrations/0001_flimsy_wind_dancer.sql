...
ALTER TABLE "applications" ADD COLUMN "program_id" uuid;--> statement-breakpoint
ALTER TABLE "applications" ADD COLUMN "goal" text;--> statement-breakpoint
ALTER TABLE "applications" ADD COLUMN "github_username" varchar(100);--> statement-breakpoint
ALTER TABLE "applications" ADD COLUMN "twitter_username" varchar(100);--> statement-breakpoint
...
ALTER TABLE "program_activities" ADD CONSTRAINT "program_activities_program_id_programs_id_fk" FOREIGN KEY ("program_id") REFERENCES "public"."programs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "program_enrollments" ADD CONSTRAINT "program_enrollments_application_id_applications_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."applications"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "attendance" ADD CONSTRAINT "attendance_program_id_programs_id_fk" FOREIGN KEY ("program_id") REFERENCES "public"."programs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
