...
>[] = [
  ...
  },
  {
    ...
    slug: 'rest-apis',
    category: 'other',
    description: 'RESTful web services and APIs',
  },
  {
    name: 'IPFS',
    slug: 'ipfs',
...
async function seedSkills() {
  ...
  try {
    ...
    if (existingSkills.length > 0) {
      console.log(
        `⚠️  Found ${existingSkills.length} existing skills. Skipping seed.`,
      )
      console.log(
        '💡 To re-seed, truncate the skills table first: TRUNCATE TABLE skills CASCADE;',
      )
      return
    }
